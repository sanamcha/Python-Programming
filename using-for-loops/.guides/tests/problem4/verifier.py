...
def grade_func1(file,step=0,outp=sys.stdout):
    """
    Returns the test result and score for the implementation of skip
    ...
    function = 'skip'
    testcase = [('hello world',1,'hello world'),('hello world',2,'hlowrd'),
                ('hello world',3,'hlwl'),('hello world',4,'hor'),
                ('hello world',5,'h d'),('goodnight moon',4,'gnto'),
                ('goodnight moon',6,'ggo'),('goodnight moon',12,'go'),
                ('goodnight moon',14,'g')]
...
def grade_func2(file,step=0,outp=sys.stdout):
    """
    Returns the test result and score for the implementation of factorial
    ...
    testcase = [((0,3,2),(0,2)), ((0,1,2,3),(0,1,2,3)), ((2,1,2,1),(1,2)),
                ((2,2,2,2),(2,)), ((3,2,1,0),()), ((),()), ((-1,0,-3,2,4),(4,))]
...
def grade_structure(file,func,step=0,outp=sys.stdout):
    ...
    if found2:
        ...
        outp.write('Function %s does not have a for-loop in it.\n' % repr(func))
        score = 0
        if not step:
            return (FAIL_INCORRECT,max(0,score))
